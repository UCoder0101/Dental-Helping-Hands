...
public class OfficeNavigationDrawer extends RelativeLayout {
    ...
    //Listeners
    private OfficeNavigationDrawer.OnHamMenuClickListener onHamMenuClickListener;
    private OfficeNavigationDrawer.OnMenuItemClickListener onMenuItemClickListener;
    private OfficeNavigationDrawer.DrawerListener drawerListener;

    public OfficeNavigationDrawer(Context context) {
        super(context);
    }


    public OfficeNavigationDrawer(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public void init(Context context) {
        ...
        View rootView = mLayoutInflater.inflate(R.layout.office_navigation_drawer, this, true);
        ...
        //profile drawer
        /*ImageView ivProfile = rootView.findViewById(R.id.ivProfile);
        Utils.Companion.setProfileImage(this, "", ivProfile);*/
    ...
    public OfficeNavigationDrawer.OnHamMenuClickListener getOnHamMenuClickListener() {
        return onHamMenuClickListener;
    }

    public void setOnHamMenuClickListener(OfficeNavigationDrawer.OnHamMenuClickListener onHamMenuClickListener) {
        this.onHamMenuClickListener = onHamMenuClickListener;
    }

    public OfficeNavigationDrawer.OnMenuItemClickListener getOnMenuItemClickListener() {
        return onMenuItemClickListener;
    }

    public void setOnMenuItemClickListener(OfficeNavigationDrawer.OnMenuItemClickListener onMenuItemClickListener) {
        this.onMenuItemClickListener = onMenuItemClickListener;
    }

    public OfficeNavigationDrawer.DrawerListener getDrawerListener() {
        return drawerListener;
    }

    public void setDrawerListener(OfficeNavigationDrawer.DrawerListener drawerListener) {
...
//        containerCV.animate().translationX(rootLayout.getX() + (rootLayout.getWidth() / 8) + (rootLayout.getWidth() / 2)).translationY(250).setDuration(500).start();
    ...
    public interface DrawerListener {
        ...
        void onDrawerStateChanged(@OfficeNavigationDrawer.State int newState);
