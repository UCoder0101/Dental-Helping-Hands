...
import com.dentalhelpinghands.activities.office.OfficeNotificationDetailActivity
...
import com.dentalhelpinghands.databinding.RowOfficeNotificationItemBinding
import com.dentalhelpinghands.models.office.loginModel.DataX


class OfficeNotificationAdapter(var activity: Activity, lstModel: MutableList<DataX>, dialog: OpenCloseNotificationDialog) :
    RecyclerView.Adapter<OfficeNotificationAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding =
            RowOfficeNotificationItemBinding.inflate(LayoutInflater.from(activity), parent, false)
    ...
    inner class ViewHolder(val binding: RowOfficeNotificationItemBinding) :
        ...
        init {
            itemView.setOnClickListener {
                ...
                if(dataX != null) {
                    val intent = Intent(activity, OfficeNotificationDetailActivity::class.java)
