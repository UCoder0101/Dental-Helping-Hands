...
import com.dentalhelpinghands.databinding.ActivityOfficeForgotPasswordBinding
import com.dentalhelpinghands.models.office.loginModel.ResponseObjectModel
import retrofit2.Call
import retrofit2.Callback
import retrofit2.Response

class OfficeForgotPasswordActivity : BaseActivity() {
    private lateinit var binding: ActivityOfficeForgotPasswordBinding

    private val TAG = "forgot password response"

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        overridePendingTransition(R.anim.enter, R.anim.exit)
        binding = ActivityOfficeForgotPasswordBinding.inflate(layoutInflater)
